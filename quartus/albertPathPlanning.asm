...
Main: ; "Real" program starts here.
				...
				LOADI  &B00101001
				OUT    SONAREN     ; turn on sonars 1, 3, and 5
				LOADI	18
				STORE	CURPOS
				LOADI	1
				STORE	POS1V
...
POS1V:			DW		1			;1 = not visited yet. 0 = visited
POS2V:			DW		1			;1 = not visited yet. 0 = visited
POS3V:			DW		1			;1 = not visited yet. 0 = visited
CURPOS:			DW		18			;Current location ID
POS1:			DW		2			;ID of first goal
POS2:			DW		10		 	;ID of second goal
POS3:			DW		15			;ID of third goal
...
WALLFOLLOW: 	OUT		RESETPOS
				LOADI	&B00101001		;Turn on Sensors 3 and 5
				OUT  	SONAREN
WALLLOOP:		IN 		DIST5
				STORE 	CURW
				SUB 	WDIST
				...
				OUT		LCD
				SUB		FOLLOWDIST
				ADDI	125				;STOP 140 SHORT. NEED TO GET BETTER WAY TO STOP OVERSHOOT
				JNEG	WALLLOOP
				LOADI	0
				OUT 	LVELCMD
				OUT 	RVELCMD
...
WALLFOLLOWLEFT:	OUT		RESETPOS
				LOADI	&B00101001		;Turn on Sensors 3 and 5
				OUT  	SONAREN
WALLLOOPLEFT:	IN 		DIST0
				STORE 	CURW
				SUB 	LDIST
				OUT 	SSEG1
				STORE 	ERRW
